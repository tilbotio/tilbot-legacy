define("StartingPointController", ["jquery", "handlebars", "Observable", "LineController", "text!/editor/views/starting_point.html"],
function($, Handlebars, Observable, LineController, view) {

  return class StartingPointController extends Observable {
    constructor() {
        super();
